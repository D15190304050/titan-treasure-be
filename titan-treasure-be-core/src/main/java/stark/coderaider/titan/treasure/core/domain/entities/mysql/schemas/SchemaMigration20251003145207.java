...
public class SchemaMigration20251003145207 extends SchemaMigrationBase {
    @Override
    public void forward() {
        setInitialized(false);
        forwardBuilder.createTable("user_system_preference", builder -> {
        ...
        forwardBuilder.createTable("user_location", builder -> {
            builder.column().name("user_id").type("BIGINT").nullable(false).unique(true).comment("IAM user ID.");
        ...
        forwardBuilder.createTable("user_profile", builder -> {
            builder.column().name("user_id").type("BIGINT").nullable(false).unique(true).comment("IAM user ID.");
    ...
    public void backward() {
        backwardBuilder.dropTable("user_system_preference");
        backwardBuilder.dropTable("user_location");
        backwardBuilder.dropTable("user_profile");
    }
}